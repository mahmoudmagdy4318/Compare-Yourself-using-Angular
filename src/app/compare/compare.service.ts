...
export class CompareService {
  ...
  onStoreData(data: CompareData) {
    ...
    this.authService.getAuthenticatedUser().getSession((err, session) => {
      ...
      this.http
        .post(
          "https://e64pi1ndje.execute-api.us-east-2.amazonaws.com/Dev/compare-yourself",
          data,
          {
            headers: new Headers({
  ...
  onDeleteData() {
    ...
    this.authService.getAuthenticatedUser().getSession((err, session) => {
      this.http
        .delete(
          "https://e64pi1ndje.execute-api.us-east-2.amazonaws.com/Dev/compare-yourself/?accessToken=xxx",
          {
            headers: new Headers({
              Authorization: session.getIdToken().getJwtToken(),
            }),
